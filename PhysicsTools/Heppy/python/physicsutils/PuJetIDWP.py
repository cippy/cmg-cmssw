...
class PuJetIDWP80X:
    def __init__(self):
        ...
        # tuning in 80X but also for 9X and 10X
        # see https://twiki.cern.ch/twiki/bin/view/CMS/PileupJetID#Working_points
        ...
        loose.SetBinContent(1,1,-0.97); loose.SetBinContent(1,2,-0.97); loose.SetBinContent(1,3,-0.97); loose.SetBinContent(1,4,-0.89);
        loose.SetBinContent(2,1,-0.68); loose.SetBinContent(2,2,-0.68); loose.SetBinContent(2,3,-0.68); loose.SetBinContent(2,4,-0.52);
        loose.SetBinContent(3,1,-0.53); loose.SetBinContent(3,2,-0.53); loose.SetBinContent(3,3,-0.53); loose.SetBinContent(3,4,-0.38);
        loose.SetBinContent(4,1,-0.47); loose.SetBinContent(4,2,-0.47); loose.SetBinContent(4,3,-0.47); loose.SetBinContent(4,4,-0.30);

        medium = grid.Clone('medium')
        medium.SetBinContent(1,1,0.18); medium.SetBinContent(1,2,0.18); medium.SetBinContent(1,3,0.18); medium.SetBinContent(1,4,0.61);
        medium.SetBinContent(2,1,-0.55); medium.SetBinContent(2,2,-0.55); medium.SetBinContent(2,3,-0.55); medium.SetBinContent(2,4,-0.35);
        medium.SetBinContent(3,1,-0.42); medium.SetBinContent(3,2,-0.42); medium.SetBinContent(3,3,-0.42); medium.SetBinContent(3,4,-0.23);
        medium.SetBinContent(4,1,-0.36); medium.SetBinContent(4,2,-0.36); medium.SetBinContent(4,3,-0.36); medium.SetBinContent(4,4,-0.17);

        tight = grid.Clone('tight')
        tight.SetBinContent(1,1,0.69); tight.SetBinContent(1,2,0.69); tight.SetBinContent(1,3,0.69); tight.SetBinContent(1,4,0.86);
        tight.SetBinContent(2,1,-0.35); tight.SetBinContent(2,2,-0.35); tight.SetBinContent(2,3,-0.35); tight.SetBinContent(2,4,-0.10);
        tight.SetBinContent(3,1,-0.26); tight.SetBinContent(3,2,-0.26); tight.SetBinContent(3,3,-0.26); tight.SetBinContent(3,4,-0.05);
        tight.SetBinContent(4,1,-0.21); tight.SetBinContent(4,2,-0.21); tight.SetBinContent(4,3,-0.21); tight.SetBinContent(4,4,-0.01);
